...
class CommentController extends AbstractController
{
    ...
    public function add(Request $request, ArticleRepository $articleRepo,EntityManagerInterface $em,UserRepository $userRepo,CommentRepository $commentRepo): Response
    {
        $commentData = $request->request->all('comment');
        if(!$this->isCsrfTokenValid('comment-add',$commentData['_token'])){
            return $this->json([
                'code' => 'INVALID_CSFR_TOKEN'
